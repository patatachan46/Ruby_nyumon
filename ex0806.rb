...
# 表示したい蔵書データを作成する（同じ蔵書は格配列の添え字が同じ）
titles = ["実践アジャイル　ソフトウェア開発法とプロジェクト管理", "入門LEGO MINDSTORMS NXT レゴブロックで作る動くロボット",]
authors = ["山田　正樹", "大庭 慎太郎",]
yomies = ["やまだまさき", "おおばしんたろう",]
publishers = ["ソフトリサーチセンター", "SBクリエイティブ",]
pages = [ 248, 164,]
prices = [2500, 2400,]
